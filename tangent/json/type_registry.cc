...
Registry::Registry() {
  register_scalar(parse_integer<uint8_t>, primitive_helper<uint8_t>);
  register_scalar(parse_integer<uint16_t>, primitive_helper<uint16_t>);
  register_scalar(parse_integer<uint32_t>, primitive_helper<uint32_t>);
  register_scalar(parse_integer<uint64_t>, primitive_helper<uint64_t>);
  register_scalar(parse_integer<int8_t>, primitive_helper<int8_t>);
  register_scalar(parse_integer<int16_t>, primitive_helper<int16_t>);
  register_scalar(parse_integer<int32_t>, primitive_helper<int32_t>);
  register_scalar(parse_integer<int64_t>, primitive_helper<int64_t>);
  register_scalar(parse_real_number<double>, primitive_helper<double>);
  register_scalar(parse_real_number<float>, primitive_helper<float>);
  register_scalar(parse_boolean, primitive_helper<bool>);
